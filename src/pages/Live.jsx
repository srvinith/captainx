...
import ProductFeatureLive from '../components/ProductFeatureLive';
...
import FaqLive from '../components/FaqLive';
...
const Live = ({ language }) => {
    const live = langData[language].live;
...
useEffect(() => {
    ...
    return (
        <>
                        ...
                        <center>
                            <div className="indual-hero-m">
                                <div className="cen-sec-con">
                                    <h6 className='sec-top-titl block-view mt-3'>{live.secTopTitle}</h6>
                                    <h2
                                        className='hero-title academy-title hr-title block-view'
                                        dangerouslySetInnerHTML={{ __html: live.title }}
                                    />
                                    <p className='block-view hero-text-p'>{live.desc}</p>
                    ...
                    <div className="row justify-content-center align-items-center">
                        ...
                        <div className="col-md-6 " ref={counterRef}>
                            <h2
                                ...
                                dangerouslySetInnerHTML={{ __html: live.futureTitle }}
                            />
                            <p className="sec-p futer-p block-view">{live.futureDesc}</p>
                        </div>
                        ...
                        <div className="col-md-4">
                            <div className="row">
                                <div className="col-md-12">
                                    <div className="num-card-box">
                                        <div className="number-count">
                                            <CountUp end={live.num1} duration={2} trigger={visible} />
                                            <span>{live.numspan}</span>
                                        </div>
                                        <div className="number-desc">{live.num1Desc}</div>
                                    </div>
                                </div>
                                ...
                                <div className="col-6">
                                    <div className="num-card-box">
                                        <div className="number-count-two">
                                            <CountUp end={live.num2} duration={2} trigger={visible} />
                                            <span>{live.numspan}</span>
                                        </div>
                                        <div className="number-desc">{live.num2Desc}</div>
                                    </div>
                                </div>
                                ...
                                <div className="col-6">
                                    <div className="num-card-box">
                                        <div className="number-count-two">
                                            <CountUp end={live.num3} duration={2} trigger={visible} />
                                            <span>{live.numsx}</span>
                                        </div>
                                        <div className="number-desc">{live.num3Desc}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <ProductFeatureLive language={language} />
            ...
            <section className='platform'>
                <div className="container">
                    <center>
                        <h2 className='sec-title'>{live.platformTitle}</h2>
                        <p className='d-none d-md-block sec-desc'>{live.platformDesc}</p>
                    </center>
                    ...
                    <div className="row justify-content-center align-items-center mt-5">
                        ...
                        <div className="col-md-4">
                            <div className="card-wrap">
                                <div className="icon-box">
                                    <div className="icon">
                                        <img src={live.platformlist1icon} alt={live.platformlist1icon} />
                                    </div>
                                    <div className="icon-box-con">
                                        <h6>{live.platformlist1Title}</h6>
                                        <p>{live.platformlist1Desc}</p>
                                    </div>
                                </div>

                                <div className="icon-box">
                                    <div className="icon">
                                        <img src={live.platformlist2icon} alt={live.platformlist2icon} />
                                    </div>
                                    <div className="icon-box-con">
                                        <h6>{live.platformlist2Title}</h6>
                                        <p>{live.platformlist2Desc}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-md-4">
                            <div className="card-wrap">
                                <div className="icon-box">
                                    <div className="icon">
                                        <img src={live.platformlist3icon} alt={live.platformlist3icon} />
                                    </div>
                                    <div className="icon-box-con">
                                        <h6>{live.platformlist3Title}</h6>
                                        <p>{live.platformlist3Desc}</p>
                                    </div>
                                </div>

                                <div className="icon-box">
                                    <div className="icon">
                                        <img src={live.platformlist4icon} alt={live.platformlist4icon} />
                                    </div>
                                    <div className="icon-box-con">
                                        <h6>{live.platformlist4Title}</h6>
                                        <p>{live.platformlist4Desc}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="container">
                    ...
                    <center>
                        <h2
                            ...
                            dangerouslySetInnerHTML={{ __html: live.ctaTitle }}
                        ></h2>
                        <p
                            className="sec-p block-view"
                            dangerouslySetInnerHTML={{ __html: live.ctadesc }}
                        ></p>
